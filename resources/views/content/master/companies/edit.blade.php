                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="company_type"
                                        class="form-select @error('company_type') is-invalid @enderror">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <select name="is_active" class="form-select @error('is_active') is-invalid @enderror">
                                        ...
                                        <option value="active"
                                            {{ old('is_active', $company->is_active) == 'active' ? 'selected' : '' }}>
                                            Active
                                        </option>

                                        <option value="inactive"
                                            {{ old('is_active', $company->is_active) == 'inactive' ? 'selected' : '' }}>
                                            Inactive
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" name="mobile"
                                        class="form-control onlydigit @error('mobile') is-invalid @enderror"
                                        value="{{ old('mobile', $company->mobile) }}"
                                        placeholder="Enter company mobile number" maxlength="10">
                        ...
                        <div class="row g-3 mt-2">
                            ...
                            <div class="col-md-6 border-end pe-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="reg_address_line2" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="reg_city"
                                            ...
                                            value="{{ old('reg_city', $company->reg_city) }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="reg_pincode"
                                            class="form-control onlydigit @error('reg_pincode') is-invalid @enderror"
                                            value="{{ old('reg_pincode', $company->reg_pincode) }}" maxlength="6">
                            ...
                            <!-- OPERATIONAL -->
                            @php
                                $office = $company->headOffices->first();
                            @endphp
                            ...
                            <div class="col-md-6 ps-4" id="operationalAddress">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="head_offices[0][address_line_1]" class="form-control"
                                        value="{{ old('head_offices.0.address_line_1', $office->address_line_1 ?? '') }}">
                                </div>

                                <div class="mb-3">
                                    <label>Address Line 2</label>
                                    <input type="text" name="head_offices[0][address_line_2]" class="form-control"
                                        value="{{ old('head_offices.0.address_line_2', $office->address_line_2 ?? '') }}">
                                </div>

                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label>City</label>
                                        <input type="text" name="head_offices[0][city]" class="form-control"
                                            value="{{ old('head_offices.0.city', $office->city ?? '') }}">
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label>State</label>
                                        <select name="head_offices[0][state]" class="form-select">
                                            <option value="Maharashtra"
                                                {{ old('head_offices.0.state', $office->state ?? '') == 'Maharashtra' ? 'selected' : '' }}>
                                                Maharashtra
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label>Postal Code</label>
                                        <input type="text" name="head_offices[0][pincode]"
                                            class="form-control onlydigit"
                                            value="{{ old('head_offices.0.pincode', $office->pincode ?? '') }}">
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label>Country</label>
                                        <select name="head_offices[0][country]" class="form-control">
                                            <option value="India"
                                                {{ old('head_offices.0.country', $office->country ?? '') == 'India' ? 'selected' : '' }}>
                                                India
                                            </option>
                                        </select>
                                    </div>
                        ...
                        <div class="row g-3 mt-2">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="tan_no" maxlength="10"
                                    ...
                                    value="{{ old('tan_no', $company->tan_no) }}">
                                @error('tan_no')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div id="bankDetailsWrapper">
                            ...
                            @foreach ($company->companyBank as $index => $bank)
                                <div class="bank-details-row row g-3 mt-2 position-relative">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="banks[{{ $index }}][account_type]" class="form-select">

                                            @php
                                                $type = old("banks.$index.account_type", $bank->account_type);
                                            @endphp

                                            <option value="savings" {{ $type == 'savings' ? 'selected' : '' }}>Saving
                                            </option>
                                            <option value="current" {{ $type == 'current' ? 'selected' : '' }}>Current
                                            </option>
                                            <option value="od_cc" {{ $type == 'od_cc' ? 'selected' : '' }}>OD/CC</option>
                                            <option value="nre" {{ $type == 'nre' ? 'selected' : '' }}>NRE</option>
                                            <option value="nri" {{ $type == 'nri' ? 'selected' : '' }}>NRI</option>
                                            <option value="nro" {{ $type == 'nro' ? 'selected' : '' }}>NRO</option>
                                            <option value="tem_deposit" {{ $type == 'tem_deposit' ? 'selected' : '' }}>
                                                Term Deposit</option>
                                            <option value="ra" {{ $type == 'ra' ? 'selected' : '' }}>Recurring
                                            </option>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="checkbox" name="banks[{{ $index }}][is_primary]"
                                            ...
                                            {{ old("banks.$index.is_primary", $bank->is_primary) == 1 ? 'checked' : '' }}>
                                    </div>

                                    <div class="col-md-1 d-flex align-items-end">
                                        <button type="button"
                                            class="btn btn-danger btn-sm removeBankRow {{ $index == 0 ? 'd-none' : '' }}">
                                            Remove
                                        </button>
                                    </div>
                            ...
                            {{-- If no bank exists (edge case) --}}
                            @if ($company->companyBank->isEmpty())
                                @include('company.partials.bank-row', ['index' => 0])
                            @endif
                            ...
                            @foreach ($docs as $doc)
                                @php
                                    $uploadedUrl =
                                        old($doc['name'] . '_url') ??
                                        ($company->{$doc['name']}
                                            ? asset('storage/' . $company->{$doc['name']})
                                            : null);
                                @endphp
                                    ...
                                    <div class="doc-card position-relative p-4 text-center {{ $uploadedUrl ? 'doc-card--uploaded' : '' }}"
                                        ...
                                        <div class="d-flex align-items-center justify-content-center gap-1 mb-1">
                                            @if ($uploadedUrl)
                                                ...
                                                <span class="small fw-medium text-success">Uploaded</span>
                                            @else
                                                <span class="status-dot status-dot--red"></span>
                                                <span class="small fw-medium text-danger">Not Uploaded</span>
                                            @endif
                                        </div>

                                        {{-- FILE INPUT --}}
                                        <input type="file" id="{{ $doc['name'] }}" name="{{ $doc['name'] }}"
                                            class="d-none" onchange="uploadTempFile(this, '{{ $doc['name'] }}')">
                                        ...
                                        @if ($uploadedUrl)
                                            ...
                                            <div class="mt-3 position-relative d-inline-block">
                                                ...
                                                @else
                                                    <div class="px-2 py-1 bg-light border rounded small">
...
@push('scripts')
    ...
    <script>
        function removeImage(field) {
            document.querySelector(`[name="${field}_url"]`).value = '';
