...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Master /</span> Agent
    </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('master.agents.store') }}" method="POST">
                        @csrf
                        @method('post')
                        <div class="row">
                            <!-- Company Name -->
                            <div class="col-md-3 mb-3">
                                <label class="form-label" for="company">Agent Name <span
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="phone" id="phone"
                                    class="form-control onlyphone @error('phone') is-invalid @enderror" value="{{ old('phone') }}"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="gst_number" id="gst_number"
                                    class="form-control @error('gst_number') is-invalid @enderror" value="{{ old('gst_number') }}"
                                    placeholder="" maxlength="15">
                                @error('gst_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="text-end mt-3">
                                ...
                                <a href="{{ route('master.agents.index') }}" class="btn btn-secondary px-4">Cancel</a>
                            </div>
                        </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                        href="{{ route('master.agents.edit', $d->id) }}"><i
                                                            class="bx bx-edit-alt me-1"></i> Edit</a>
                                                  <form action="{{ route('master.agents.destroy', $d->id) }}" method="post"                         onsubmit="return confirmDelete()">
