{{-- resources/views/master/branches/create.blade.php --}}
                        ...
                        <div class="row g-3 mt-2">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="head_office_id" id="head_office_id"
                                    ...
                                    @foreach ($headOffices as $ho)
                                        <option value="{{ $ho->id }}"
                                            {{ old('head_office_id') == $ho->id ? 'selected' : '' }}>
                                            {{ $ho->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="code"
                                    ...
                                    value="{{ old('code') }}" placeholder="e.g. BR-MUM-01">
                                @error('code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="branch_type"
                                    ...
                                    <option value="sales"       {{ old('branch_type') == 'sales'       ? 'selected' : '' }}>Sales</option>
                                    <option value="service"     {{ old('branch_type') == 'service'     ? 'selected' : '' }}>Service</option>
                                    <option value="warehouse"   {{ old('branch_type') == 'warehouse'   ? 'selected' : '' }}>Warehouse</option>
                                    <option value="regional"    {{ old('branch_type') == 'regional'    ? 'selected' : '' }}>Regional</option>
                                    <option value="zonal"       {{ old('branch_type') == 'zonal'       ? 'selected' : '' }}>Zonal</option>
                                    <option value="franchise"   {{ old('branch_type') == 'franchise'   ? 'selected' : '' }}>Franchise</option>
                                </select>
                                @error('branch_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="employee_count" min="0"
                                    ...
                                    value="{{ old('employee_count') }}" placeholder="0">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="opening_hours"
                                    ...
                                    value="{{ old('opening_hours') }}" placeholder="Mon–Sat 9am–6pm">
                                @error('opening_hours')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
    ...
    function loadHeadOffices(companyId) {
        ...
        fetch(`/api/companies/${companyId}/head-offices`)
            ...
            .then(data => {
                select.innerHTML = '<option value="">Select Head Office</option>';
                data.forEach(ho => {
                    select.innerHTML += `<option value="${ho.id}">${ho.name}</option>`;
                });
            })
            .catch(() => {
                select.innerHTML = '<option value="">Select Head Office</option>';
