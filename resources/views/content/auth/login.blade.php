            ...
            <form id="loginForm" class="mb-3" action="{{ route('login') }}" method="post">
                ...
                <div class="organic-field">
                    ...
                    <button type="button" class="nature-toggle" id="passwordToggle">
                        <i class="bx bx-hide eye-visible"></i>
                        <i class="bx bx-show eye-hidden"></i>
                    </button>
                    <div class="growth-indicator">
                        <div class="leaf-sprout"></div>
                    </div>
    ...
    <script>
        class EcoWellnessLoginForm {
            ...
            togglePassword() {
                ...
                this.passwordToggle.classList.toggle('toggle-visible', !isVisible);
            }
            ...
            validateEmail() {
                ...
                if (!pattern.test(value)) {
                    this.showError(this.emailError, 'Please enter a valid email.');
                    return false;
                }
