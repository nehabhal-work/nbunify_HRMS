                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($d->attachment_client_photo_url)
                                                    <a href="{{ $d->attachment_client_photo_url }}" target="_blank">
                                                        <img src="{{ $d->attachment_client_photo_url }}" alt=""
                                                            width="80">
                                                    </a>
                                                @endif
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($d->attachment_aadhar_front_url)
                                                    <a href="{{ $d->attachment_aadhar_front_url }}" target="_blank">
                                                        <img src="{{ $d->attachment_aadhar_front_url }}" alt=""
                                                            width="80">
                                                    </a>
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                @if ($d->attachment_aadhar_back_url)
                                                    <a href="{{ $d->attachment_aadhar_back_url }}" target="_blank">
                                                        <img src="{{ $d->attachment_aadhar_back_url }}" alt=""
                                                            width="80">
                                                    </a>
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                @if ($d->attachment_signature_url)
                                                    <a href="{{ $d->attachment_signature_url }}" target="_blank">
                                                        <img src="{{ $d->attachment_signature_url }}" alt=""
                                                            width="80">
                                                    </a>
                                                @endif
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                @if ($d->attachment_other_documents_url)
                                                    <a href="{{ $d->attachment_other_documents_url }}" target="_blank">
