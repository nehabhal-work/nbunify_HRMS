...
@section('content')
    ...
    <form action="{{ route('master.employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="date" class="form-control  @error('dob') is-invalid @enderror"
                                    name="dob" value="{{ old('dob', $employee->dob) }}"  max="{{ now()->toDateString() }}" >
                                @error('dob')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control onlyphone @error('phone') is-invalid @enderror"
                                    name="phone" maxlength="10" value="{{ old('phone', $employee->phone) }}">
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control onlydigit @error('aadhar') is-invalid @enderror"
                                    name="aadhar" maxlength="12" value="{{ old('aadhar', $employee->aadhar) }}">
                                @error('aadhar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control @error('pan') is-invalid @enderror" name="pan"
                                    maxlength="10" value="{{ old('pan', $employee->pan) }}"
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="res_address"
                                    ...
                                    value="{{ old('res_address', $employee->res_address) }}">
                                @error('res_address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <select name="res_country_code" id="res_country_code"
                                    ...
                                    <option value="{{ $country['iso2'] }}"
                                        {{ old('res_country_code', $employee->res_country_code) == $country['iso2'] ? 'selected' : '' }}>
                                        {{ $country['name'] }}
                                    </option>
                                </select>
                                ...
                                <select name="res_state_code" id="res_state_code"
                                    ...
                                    @foreach ($states as $state)
                                        <option value="{{ $state['iso2'] }}"
                                            {{ old('res_state_code', $employee->res_state_code) == $state['iso2'] ? 'selected' : '' }}>
                                            {{ $state['name'] }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <select name="res_city_code" id="res_city_code"
                                    ...
                                    @foreach ($cities as $c)
                                        <option value="{{ $c['id'] }}"
                                            {{ old('res_city_code', $employee->res_city_code) == $c['id'] ? 'selected' : '' }}>
                                            {{ $c['name'] }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" name="res_pincode"
                                    ...
                                    value="{{ old('res_pincode', $employee->res_pincode) }}" maxlength="6">
                                @error('res_pincode')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <select name="branch_id" class="form-select @error('branch_id') is-invalid @enderror">
                                    ...
                                    @foreach ($branches as $b)
                                        <option value="{{ $b->id }}"
                                            {{ old('branch_id', $employee->branch_id) == $b->id ? 'selected' : '' }}>
                                            {{ $b->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <select name="deptment_id"
                                    ...
                                    @foreach ($departments as $d)
                                        <option value="{{ $d->id }}"
                                            {{ old('deptment_id', $employee->deptment_id) == $d->id ? 'selected' : '' }}>
                                            {{ $d->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="joining_date" value="{{ old('joining_date', $employee->joining_date) }}"
                                    readonly>
                                @error('joining_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text"
                                    class="form-control onlydigit @error('probation_date') is-invalid @enderror"
                                    name="probation_date" value="{{ old('probation_date', $employee->probation_date) }}">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="notice_date" value="{{ old('notice_date', $employee->notice_date) }}">
                                @error('notice_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <select name="status" class="form-select">
                                    @foreach (['contract', 'permanent', 'probation', 'intern'] as $s)
                                        <option value="{{ $s }}"
                                            {{ old('status', $employee->status) == $s ? 'selected' : '' }}>
                                            {{ ucfirst($s) }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control onlydigit @error('hra') is-invalid @enderror"
                                    name="hra" id="hra" value="{{ old('hra', $employee->hra ?? '') }}">
                                @error('hra')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="travel_allowance" id="travel_allowance"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control onlydigit @error('bonus') is-invalid @enderror"
                                    name="bonus" id="bonus" value="{{ old('bonus', $employee->bonus ?? '') }}">
                                @error('bonus')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
