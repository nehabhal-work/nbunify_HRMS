...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Accounts /</span> <a href="{{ route('accounts.purchases.index') }}">Puchase
            order</a>
    </h4>
    ...
    <form action="{{ route('accounts.purchases.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <small class="text-muted float-end">Purchase-order Basic Details</small>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div id="divVendolList" class="col-md-4">
                                <label class="form-label" for="vendorid">Vendor Name</label>
                                <select id="vendorid" name="vendorid"
                                    class="form-control @error('vendorid') is-invalid @enderror" required>
                                ...
                                @error('vendorid')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <a href="{{ route('accounts.vendors.create') }}" class="text-info d-block mt-2">Create new
                                    vendor if not
                                    exist</a>
                            </div>
                            ...
                            <div id="divBilldt" class="col-md-2 mb-3">
                                ...
                                <input type="date" id="billdate" name="billdate"
                                    class="form-control @error('billdate') is-invalid @enderror" required />
                                @error('billdate')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div id="divBilldt" class="col-md-5 mb-3">
                                <label class="form-label" for="tnc">Terms & Conditions</label>
                                <div>
                                    <textarea class="form-control @error('tnc') is-invalid @enderror" name="tnc" id="tnc" rows="2"></textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="100" name="particular[]" value="{{ old('particular.0') }}" />
                                        @error('particular.*')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-3 form-group d-none">
                                        ...
                                        <input type="text" class="form-control hsn @error('hsn.*') is-invalid @enderror"
                                            maxlength="15" name="hsn[]" value="{{ old('hsn.0') }}" />
                                        @error('hsn.*')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="15" name="amount[]" value="{{ old('amount.0') }}" />
                                        @error('amount.*')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="15" name="quantity[]" value="{{ old('quantity.0') }}" />
                                        @error('quantity.*')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="15" name="billamt[]" value="{{ old('billamt.0') }}" />
                                        @error('billamt.*')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-3 form-group d-none">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="10" name="cgst[]" value="{{ old('cgst.0') }}" readonly />
                                        @error('cgst.*')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-3 form-group d-none">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="10" name="sgst[]" value="{{ old('sgst.0') }}" readonly />
                                        @error('sgst.*')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-3 igst-container d-none">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="10" name="igst[]" value="{{ old('igst.0') }}" readonly />
                                        @error('igst.*')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-3 form-group d-none">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="10" name="gstamt[]" value="{{ old('gstamt.0') }}" readonly />
                                        @error('gstamt.*')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            maxlength="30" name="totalamt[]" value="{{ old('totalamt.0') }}" readonly />
                                        @error('totalamt.*')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
        ...
        <div class="text-end mt-3">
            ...
            <a href="{{ route('accounts.purchase-orders.index') }}" class="btn btn-secondary px-4">Cancel</a>
        </div>
    </form>
