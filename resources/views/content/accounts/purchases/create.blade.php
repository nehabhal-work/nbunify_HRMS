                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div id="divInvno" class="col-md-2 mb-3">
                                <label class="form-label" for="invoiceno">Invoice Number</label>
                                <input type="text" class="form-control @error('invoiceno') is-invalid @enderror"
                                    id="invoiceno" required maxlength="20" name="invoiceno"
                                    value="{{ old('invoiceno') }}" />
                                @error('invoiceno')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('input', '.amount, .quantity', function() {
                ...
                // Get stateId from selected vendor
